...
Uses a drain goal plus one goal per worker, claims items in-progress before work, marks them done or blocked after work, emails on completion, and skips in-progress/done/blocked items to avoid collisions.
